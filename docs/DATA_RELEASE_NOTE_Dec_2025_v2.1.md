...
All thresholds match the original implementation (5×SD for PCA, 5×MAD for technical, 4×SD for Z-score and pQTL). Pipeline version: v1.7.0

---

**Pipeline Version**: v1.7.0 (January 2026 - Refactored)
